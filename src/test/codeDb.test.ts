...
suite('codeDb Test Suite', () => {
    ...
    test('codeFile test', async () => {
        ...
        const empty_codes = await db.codeFile_query(null);
        ...
        const insert_codes1 = await db.codeFile_query(null);
        ...
        const update_codes1 = await db.codeFile_query(null);
        ...
        const insert_codes2 = await db.codeFile_query(null);
